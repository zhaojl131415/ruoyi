...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '湖南省中医药研究院',   0, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '中药资源研究所', 1, '', '', '', '0', '0', 'admin', sysdate(), '', null);
...
insert into sys_user values(2,  105, 'test',    '测试员', '00', 'test@163.com',  '18611112222', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_post values(2, 'PM',   '项目经理',  2, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(3, 'STAFF', '员工',  3, '0', 'admin', sysdate(), '', null, '');
...
) engine=innodb auto_increment=12 comment = '参数配置表';
